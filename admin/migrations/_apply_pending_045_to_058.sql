...
DECLARE
  ...
  msg TEXT;
BEGIN
  -- Helper-style probes — each catches its own errors so we don't blow up
  -- the whole verification on one failure.
  ...
  FOR rec IN VALUES
    ...
    ('055 retail_order_status_lookup RPC', 'SELECT retail_order_status_lookup(''00000000-0000-0000-0000-000000000000''::uuid)'),
  ...
  IF failed = 0 THEN
    RAISE NOTICE '🛹 All Square-replica migrations landed cleanly.';
  ELSE
